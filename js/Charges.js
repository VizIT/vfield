...
(function (ns) {
    /**
     * Represents a single point charge in a set of charges
     * A charge has position and a charge in stat-Columbs.
     *
     * @param {number} x_ The x coordinate of the charge.
     * @param {number} y_ The y coordinate of the charge.
     * @param {number} z_ The z coordinate of the charge.
     * @param {number} [fieldLineDensity_] The ratio of field lines to charge.
