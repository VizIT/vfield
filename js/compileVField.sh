...
$JAVA -jar $CLOSURE_HOME/compiler.jar --js current_license.js \
  EnsureNumber.js MotionEventHandler.js GLUtility.js Color.js Geometry.js SurfaceRenderer.js \
  IndexedVertices.js VectorFunction.js CombinedVectorFunctions.js LineRenderer.js \
  SimpleVectorField.js CountdownLatch.js ChargeGenerator.js ChargeRenderer.js FieldLineVBO.js \
  FieldLine.js FieldLineGenerator.js FieldLineRenderer.js Cylinder.js GaussianCylinder.js \
