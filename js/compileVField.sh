...
$JAVA -jar $CLOSURE_HOME/compiler.jar --js current_license.js \
  EnsureNumber.js toBoolean.js MotionEventHandler.js GLUtility.js Color.js Geometry.js \
  SurfaceRenderer.js IndexedVertices.js VectorFunction.js CombinedVectorFunctions.js \
