...
this.setDs=function(a){k=a;return this};this.getDs=function(){return k};this.drawArrow=function(a,b,d,c,f,g,k){var l,e,h,q,m;l=c[0]/f;e=c[1]/f;h=c[2]/f;0!==h?(q=f=1,c=-(c[0]+c[1])/c[2]):(0!==e?(f=1,q=-(c[0]+c[2])/c[1]):(f=-(c[1]+c[2])/c[0],q=1),c=1);m=g/Math.sqrt(f*f+q*q+c*c);f*=m;q*=m;c*=m;l*=g;e*=g;g*=h;k.pushArrow(a-l+f,b-e+q,d-g+c,a,b,d,a-l-f,b-e-q,d-g-c)};this.generate=function(a,c,d,e){var h,u,m,t;h=0;u=!1;t=d;l.reset();for(d=0;d<q&&!u;d++){l.pushPoint(a,c,t);m=g.getField(a,c,t);u=Math.sqrt(m[0]*
m[0]+m[1]*m[1]+m[2]*m[2]);if(0===u)break;a+=e*m[0]/u*k;c+=e*m[1]/u*k;t+=e*m[2]/u*k;h+=k;h>f&&(h=0,this.drawArrow(a,c,t,m,u,b,l));u=g.shouldStop(e,a,c,t)}return l};b=c;f=d;g=e;k=a;q=h;l=new vizit.electricfield.FieldLine(q)}})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
...
this.setName=function(a){g=a};this.getName=function(){return g};this.getModelView=function(a){"undefined"===typeof a&&(a=1);"undefined"===typeof k?(k=new Float32Array(16),k[0]=a,k[1]=0,k[2]=0,k[3]=0,k[4]=0,k[5]=a,k[6]=0,k[7]=0,k[8]=0,k[9]=0,k[10]=a,k[11]=0,k[12]=q,k[13]=p,k[14]=s,k[15]=1):(k[0]=a,k[5]=a,k[10]=a);return k};this.drawFullSurface=function(a,b,c,d,f,g){var e;e=a.getGLContext();a.bindBuffer(c,b.getPositionHandle(),3,e.FLOAT,0,0);a.bindBuffer(d,b.getNormalHandle(),3,e.FLOAT,0,0);e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,
f);e.drawElements(e.TRIANGLES,g,e.UNSIGNED_SHORT,0)};this.render=function(a,c){if(f){var d,g,e;d=a.getGLContext();g=this.getIntrinsicRadius();e=this.getVertexBuffers(a);d.uniformMatrix4fv(c.getModelViewMatrixHandle(),!1,this.getModelView(l/g));d.uniform4f(c.getSurfaceColorHandle(),b.getRed(),b.getGreen(),b.getBlue(),b.getAlpha());d.cullFace(d.FRONT);this.drawFullSurface(a,c,e.vertices,e.normals,e.indices,this.getNindices());d.cullFace(d.BACK);this.drawFullSurface(a,c,e.vertices,e.normals,e.indices,
...
this.sign(y);b=Math.max(2,Math.round(Math.abs(y*Math.PI*(G*G-B*B)*C*s)))+u;d=(B+1)/G;c=0.707106781*(B+1)/G;f=-0.5;a=1/(b-1);for(var l=0;l<b;l++)e.push([d,0,f,g]),e.push([-d,0,f,g]),e.push([0,d,f,g]),e.push([0,-d,f,g]),e.push([c,c,f,g]),e.push([c,-c,f,g]),e.push([-c,-c,f,g]),e.push([-c,c,f,g]),f+=a}return this.transformPoints(n,s/this.getBaseHeight(),G/this.getBaseRadius(),e)};this.getNormal=function(a,b,c){var d,f,g,e;d={};f=-((H-a)*L+(A-b)*J+(E-c)*M)/(N*N);g=H+f*L;e=A+f*J;f=E+f*M;d.x=a-g;d.y=b-e;
d.z=c-f;return d};this.getField=function(a,b,c){var d;d=Array(3);b=this.getNormal(a,b,c);c=Math.sqrt(b.x*b.x+b.y*b.y+b.z*b.z);a=2*(c<B?0:c<G?Math.PI*(c*c-B*B)*y:Math.PI*(G*G-B*B)*y)/c;d[0]=a*b.x/c;d[1]=a*b.y/c;d[2]=a*b.z/c;return d};this.render=function(a,b){this.fullRender(a,b,n,s/this.getBaseHeight(),B/this.getBaseRadius(),G/this.getBaseRadius(),!1)};r=!0;m=p;y="undefined"===typeof g?0:g;C="undefined"===typeof l?0:l;u="undefined"===typeof q?0:q;B=f;G=k;H=e;A=h;E=a;x=c;z=d;D=b;f=0<y?new vizit.utility.Color(0.05,
...
a;r=!0;return this};this.getNfieldLines=function(){return u};this.setModified=function(a){r=a;return this};this.isModified=function(){return r};this.setName=function(a){m=a;return this};this.getName=function(){return m};this.getStartPoints=function(){var a,b,c,d,f;f=[];if(0!==p+u){d=this.sign(q);b=Math.max(2,Math.round(Math.abs(q*p*s)))+u;c=-0.5;a=1/(b-1);for(var g=0;g<b;g++)f.push([1,0,c,d]),f.push([-1,0,c,d]),f.push([0,1,c,d]),f.push([0,-1,c,d]),f.push([0.707106781,0.707106781,c,d]),f.push([0.707106781,
-0.707106781,c,d]),f.push([-0.707106781,-0.707106781,c,d]),f.push([-0.707106781,0.707106781,c,d]),c+=a}return this.transformPoints(n,s/this.getBaseHeight(),(y+1)/this.getBaseRadius(),f)};this.getNormal=function(a,b,c){var d,f,g,e;d={};f=-((F-a)*z+(K-b)*D+(H-c)*L)/(J*J);g=F+f*z;e=K+f*D;f=H+f*L;d.x=a-g;d.y=b-e;d.z=c-f;return d};this.getField=function(a,b,c){var d;c=this.getNormal(a,b,c);d=Math.sqrt(c.x*c.x+c.y*c.y+c.z*c.z);a=Array(3);b=2*q/d;a[0]=b*c.x/d;a[1]=b*c.y/d;a[2]=b*c.z/d;return a};this.render=
...
a[0])-(a[3]-a[0])*(a[11]-a[2]);b[2]=(a[3]-a[0])*(a[10]-a[1])-(a[4]-a[1])*(a[9]-a[0]);a=Math.sqrt(b[0]*b[0]+b[1]*b[1]+b[2]*b[2]);b[0]/=a;b[1]/=a;b[2]/=a;return b};this.adjustStartPoints=function(a){var b,c,d,f,g;b=a.length;for(var e=0;e<b;e++)c=a[e],d=c[0],f=c[1],g=c[2],c[0]=N+G*(J*d*C+g*x)+D*(-M*f*B+z*(-J*d*x+g*C)),c[1]=O+G*(M*f*B+z*(J*d*x-g*C))+D*(J*d*C+g*x),c[2]=P+M*f*z+B*(-J*d*x+g*C);return a};this.getStartPoints=function(){var a,b,c,d,f,g,e;b=Math.abs(L*E)+H/Math.abs(J*M);f=[];if(0<b)for(a=Math.sqrt(1/
b),b=a/Math.abs(J),a/=Math.abs(M),c=!1,d=0<L?1:-1,g=Math.min(-0.5+b/2,0.5),e=Math.min(-0.5+a/2,0.5);!c;)f.push([g,e,0.4,d]),f.push([g,e,-0.4,d]),e+=a,0.5<e?(e=0.5-(e-0.5),g+=b,a=-a):-0.5>e&&(e=-0.5-(e- -0.5),g+=b,a=-a),c=0.5<g;return this.adjustStartPoints(f)};this.getField=function(a,b,c){var d;d=Array(3);a=(a-y[0])*A[0]+(b-y[1])*A[1]+(c-y[2])*A[2];b=S*L;0===a&&(d[0]=0,d[1]=0,d[2]=0);0<a?(d[0]=b*A[0],d[1]=b*A[1],d[2]=b*A[2]):(d[0]=-b*A[0],d[1]=-b*A[1],d[2]=-b*A[2]);return d};this.translateBoundingBox=
