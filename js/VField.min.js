...
*/
window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};(function(m){m.ensureNumber=function(e){return"number"===typeof e?e:parseFloat(e)}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};(function(m){m.toBoolean=function(e){var k,a;a=typeof e;if("boolean"===a)k=e;else if("number"===a)k=0!==e;else if("string"===a)switch(e.trim().toLowerCase()){case "f":case "false":case "n":case "no":case "0":case "":k=!1;break;default:k=!0}return k}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};
