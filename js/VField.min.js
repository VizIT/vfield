...
l,h=16+20*x,k=0<k.getCharge()?d:0>k.getCharge()?c:e,g[h++]=k[0],g[h++]=k[1],g[h++]=k[2],g[h++]=k[3];return f};a=g;h=3*Float32Array.BYTES_PER_ELEMENT+Float32Array.BYTES_PER_ELEMENT+4*Uint8Array.BYTES_PER_ELEMENT;f=new ArrayBuffer(h*a.getCharges().length);l=16;c=[204,13,13,77];d=[13,13,204,77];e=[13,13,13,51]}})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
...
(function(m){m.GaussianSphere=function(g,h,a,f,b){var c,e,l,d,k,s,p;this.setColor=function(a){c=a};this.getColor=function(){return c};this.setX=function(a){k=a;return this};this.getX=function(){return k};this.setY=function(a){s=a;return this};this.getY=function(){return s};this.setZ=function(a){p=a;return this};this.getZ=function(){return p};this.setRadius=function(a){d=a;return this};this.getRadius=function(){return d};this.setName=function(a){l=a};this.getName=function(){return l};this.getModelView=
function(a){"undefined"===typeof a&&(a=1);"undefined"===typeof e?(e=new Float32Array(16),e[0]=a,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=a,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=a,e[11]=0,e[12]=k,e[13]=s,e[14]=p,e[15]=1):(e[0]=a,e[5]=a,e[10]=a);return e};this.drawFullSurface=function(a,b,c,d,e,f){var g;g=a.getGLContext();a.bindBuffer(c,b.getPositionHandle(),3,g.FLOAT,0,0);a.bindBuffer(d,b.getNormalHandle(),3,g.FLOAT,0,0);g.bindBuffer(g.ELEMENT_ARRAY_BUFFER,e);g.drawElements(g.TRIANGLES,f,g.UNSIGNED_SHORT,0)};
this.render=function(a,b){var e,f,g;e=a.getGLContext();f=this.getIntrinsicRadius();g=this.getVertexBuffers(a);e.uniformMatrix4fv(b.getModelViewMatrixHandle(),!1,this.getModelView(d/f));e.uniform4f(b.getSurfaceColorHandle(),c.getRed(),c.getGreen(),c.getBlue(),c.getAlpha());e.cullFace(e.FRONT);this.drawFullSurface(a,b,g.vertices,g.normals,g.indices,this.getNindices());e.cullFace(e.BACK);this.drawFullSurface(a,b,g.vertices,g.normals,g.indices,this.getNindices())};c=new vizit.utility.Color(0.5,0.5,0.5,
0.5);l=b;d=f;k=g;s=h;p=a};m.GaussianSphere.prototype=new vizit.geometry.Sphere})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
