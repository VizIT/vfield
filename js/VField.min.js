...
*/
'use strict';class IllegalArgumentException extends Error{constructor(r){super(r);this.name="IllegalArgumentException"}};window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};(function(r){r.ensureNumber=function(q){return"number"===typeof q?q:parseFloat(q)}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};(function(r){r.toBoolean=function(q){var k=typeof q;if("boolean"===k)var b=q;else if("number"===k)b=0!==q;else if("string"===k)switch(q.trim().toLowerCase()){case "f":case "false":case "n":case "no":case "0":case "":b=!1;break;default:b=!0}return b}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};
(function(r){r.MotionEventHandler=function(q,k,b,c){var a;var e=[];var h=!1;var l=a=null;this.findTouchByIdentifier=function(d){var f;for(f=0;f<e.length;f++){var m=e[f].identifier;if(m===d)return f}return-1};this.handleTouchStart=function(d){var f;var m=d.targetTouches;for(f=0;f<m.length;f++){var g=m[f];-1===this.findTouchByIdentifier(g.identifier)&&e.push(g)}if(d.preventDefault)d.preventDefault();else return!1};this.handleTouchEnd=function(d){var f;var m=d.changedTouches;for(f=0;f<m.length;f++){var g=
this.findTouchByIdentifier(m[f].identifier);-1!==g&&e.splice(g,1)}if(d.preventDefault)d.preventDefault();else return!1};this.handleOneActiveMove=function(d){var f=d.changedTouches[0];var m=e[0];if(null!==m){var g=f.pageX-m.pageX;m=f.pageY-m.pageY;var t=q.getModelViewMatrix();k.rotateBy(t,m/150,g/150);q.setModelViewMatrix(t);q.requestRender();e.splice(0,1,f)}else e.push(f);if(d.preventDefault)d.preventDefault();else return!1};this.handleTwoActiveMove=function(d){var f=e[0];var m=e[1];var g=m.pageX-
f.pageX;var t=m.pageY-f.pageY;var n=Math.sqrt(g*g+t*t);var p=d.changedTouches;for(g=0;g<p.length;g++){var v=p[g];t=v.identifier;f.identifier===t?(f=v,e.splice(0,1,v)):m.identifier===t&&(m=v,e.splice(1,1,v))}g=m.pageX-f.pageX;t=m.pageY-f.pageY;q.zoomBy(-(Math.sqrt(g*g+t*t)-n)/c);if(d.preventDefault)d.preventDefault();else return!1};this.handleTouchMove=function(d){return 1===e.length?this.handleOneActiveMove(d):2===e.length?this.handleTwoActiveMove(d):!0};this.handleMouseDown=function(d){h=!0;a=d.clientX;
l=d.clientY};this.handleMouseUp=function(d){h=!1};this.handleMouseMove=function(d){if(h){var f=d.clientX,m=d.clientY,g=f-a,t=m-l;d=q.getModelViewMatrix();k.rotateBy(d,t/30,g/30);q.setModelViewMatrix(d);q.requestRender();a=f;l=m}};this.handleMouseWheel=function(d){d=window.event||d;q.zoomBy((20*d.detail|d.deltaY|-d.wheelDeltaY)/b);if(d.preventDefault)d.preventDefault();else return!1}}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};
(function(r){r.GLUtility=function(q){this.getGLContext=function(){!b&&(b=k.getContext("webgl",{antialias:!0}))&&(b.enable(b.DEPTH_TEST),b.depthFunc(b.LESS));return b};this.clearColor=function(c,a,e,h){b.clearColor(c,a,e,h)};this.clear=function(){b.clear(b.COLOR_BUFFER_BIT)};this.compileShader=function(c,a){a=b.createShader(a);b.shaderSource(a,c);b.compileShader(a);if(!b.getShaderParameter(a,b.COMPILE_STATUS))throw"Shader compile failed with:"+b.getShaderInfoLog(a);return a};this.createProgram=function(c,
...
h=Math.cos(a);c=Math.sin(c);a=Math.sin(a);return[h,c*a-e*a,0,0,e,c,0,a,-h*c,e*h,0,0,0,0,1]};this.rotateBy=function(c,a,e){var h=Math.cos(a),l=Math.cos(e);a=Math.sin(a);var d=Math.sin(e),f=a*d,m=l*a,g=h*d,t=h*l;e=c[0];var n=c[1];var p=c[2];c[0]=e*l+p*d;c[1]=e*f+n*h-p*m;c[2]=-e*g+n*a+p*t;e=c[4];n=c[5];p=c[6];c[4]=e*l+p*d;c[5]=e*f+n*h-p*m;c[6]=-e*g+n*a+p*t;e=c[8];n=c[9];p=c[10];c[8]=e*l+p*d;c[9]=e*f+n*h-p*m;c[10]=-e*g+n*a+p*t;e=c[12];n=c[13];p=c[14];c[12]=e*l+p*d;c[13]=e*f+n*h-p*m;c[14]=-e*g+n*a+p*t};
...
{SPHERE:{value:"sphere"},SQUARE:{value:"square"},CYLINDER:{value:"cylinder"},LINE_SEGMENT:{value:"line segment"}};r.VertexRegistry=function(){var q={};this.registerVertices=function(k,b){if(q.hasOwnProperty(k))throw"Vertex buffers already registered for "+k+".";q[k]=b};this.hasVertices=function(k){return q.hasOwnProperty(k)};this.retrieveVertices=function(k){return q[k]}};r.vertexRegistry=new r.VertexRegistry;r.Square=function(){var q=r.Shapes.SQUARE;var k=[-.5,.5,0,.5,.5,0,.5,-.5,0,-.5,-.5,0];var b=
[0,0,1];this.getNindices=function(){return 6};this.computeGeometry=function(c,a){var e=c.getVertices();var h=c.getNormals();var l=c.getIndices();for(var d=0;12>d;d++)e[d]=a[d],h[d]=b[d%3];l[0]=0;l[1]=3;l[2]=1;l[3]=3;l[4]=2;l[5]=1;c.setNvertices(12);c.setNindices(6)};this.getVertexBuffers=function(c){if(this.hasVertices(q.value))var a=this.retrieveVertices(q.value);else{var e=new r.Surface(4,6);a={};this.computeGeometry(e,k);a.vertices=c.createBuffer(e.getVertices());a.normals=c.createBuffer(e.getNormals());
a.indices=c.createIndexBuffer(e.getIndices());this.registerVertices(q.value,a)}return a}};r.Square.prototype=r.vertexRegistry;r.LineSegment=function(){const q=r.Shapes.LINE_SEGMENT;this.getBaseHeight=function(){return 1};this.getBaseHalfWidth=function(){return.5};this.getShape=function(){return q}};r.Cylinder=function(){var q=r.Shapes.CYLINDER;this.getBaseHeight=function(){return 1};this.getBaseRadius=function(){return 1};this.getShape=function(){return q};this.getNindices=function(){return 126};
...
function(){return b};this.getDirectionalColorHandle=function(){return c};this.getModelViewMatrixHandle=function(){return e};this.getGlobalModelViewMatrixHandle=function(){return a};this.getNormalHandle=function(){return h};this.getNormalMatrixHandle=function(){return l};this.getPositionHandle=function(){return d};this.getProjectionMatrixHandle=function(){return f};this.getSurfaceColorHandle=function(){return m};this.render=function(p,v,A,x){var w=x.length;if(0<w)for(t.useProgram(n),t.uniformMatrix4fv(a,
!1,v),t.uniformMatrix3fv(l,!1,A),t.uniformMatrix4fv(f,!1,p),t.uniform3f(k,.3,.3,.3),t.uniform3f(b,1,1,1),t.uniform3f(c,.4,.4,.4),p=0;p<w;p++)x[p].render(g,this)};var g=q;var t=g.getGLContext();var n=this.createProgram()}})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};(function(r){r.IndexedVertices=function(q,k){let b,c;this.getNindices=function(){return b};this.getNvertices=function(){return c};this.getVertices=function(){return a};this.push=function(h){a[c++]=h};this.getIndices=function(){return e};this.pushIndex=function(h){e[b++]=h};this.reset=function(){c=b=0};const a=new Float32Array(q),e=new Uint16Array(k);this.reset()}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.vectorfield=window.vizit.vectorfield||{};(function(r){r.VectorFunction=function(q,k){var b;this.setModified=function(a){c=a};this.isModified=function(){return c};this.setName=function(a){b=a};this.getName=function(){return b};this.shouldStop=function(a,e,h,l){return 0>a*Q&&4>r2};this.getField=new Function(q,k);var c=!0}})(window.vizit.vectorfield);window.vizit=window.vizit||{};window.vizit.vectorfield=window.vizit.vectorfield||{};
(function(r){r.CombinedVectorFunctions=function(){var q;this.addFunction=function(a){b=c.push(a);return this};for(var k=0;k<arguments.length;k++)this.addFunction(arguments[k]);this.getNfunctions=function(){return b};this.getFunctions=function(){return c};this.isModified=function(){var a=!1;for(k=0;k<b&&!a;k++)a=a||c[k].isModified();return a};this.setModified=function(a){for(k=0;k<b;k++)c[k].setModified(a)};this.setStartPoints=function(a){q=a};this.getStartPoints=function(){return q};this.getField=
...
(function(r){r.LineRenderer=function(q){this.createProgram=function(){const a=k.createProgram("attribute vec3  current;attribute vec3  other;attribute float normalDisplacement;attribute float parallelDisplacement;uniform   vec2  resolution;uniform   mat4  modelViewMatrix;uniform   mat4  projectionMatrix;void main(){  mat4 projModelView    = projectionMatrix * modelViewMatrix;  vec4 currentProjected = projModelView * vec4(current, 1.0);  vec4 otherProjected   = projModelView * vec4(other, 1.0);  vec2 currentScreen    = currentProjected.xy / currentProjected.w;  vec2 otherScreen      = otherProjected.xy / otherProjected.w;  vec2 dir              = otherScreen - currentScreen;  dir                   = (dir == vec2(0.0, 0.0) ? dir : normalize(dir));  vec2 normal           = vec2(-dir.y, dir.x);  vec4 offset = vec4(normal*normalDisplacement, 0.0, 0.0);  offset     +=  vec4(dir * parallelDisplacement, 0.0, 0.0);  offset.xy  /= resolution * currentProjected.w;  gl_Position = currentProjected + offset;}","precision mediump float;uniform   vec4 color;void main(){    gl_FragColor = color;}"),
e=k.getAttribLocation(a,"current"),h=k.getAttribLocation(a,"other"),l=k.getAttribLocation(a,"normalDisplacement"),d=k.getAttribLocation(a,"parallelDisplacement"),f=k.getUniformLocation(a,"resolution"),m=k.getUniformLocation(a,"color"),g=k.getUniformLocation(a,"modelViewMatrix"),t=k.getUniformLocation(a,"projectionMatrix");return{program:a,currentHandle:e,otherHandle:h,normalDisplacementHandle:l,parallelDisplacementHandle:d,resolutionHandle:f,colorHandle:m,modelViewMatrixHandle:g,projectionMatrixHandle:t}};
this.drawIndexedLines=function(a,e,h,l){const d=new Float32Array(2);d[0]=b.drawingBufferWidth;d[1]=b.drawingBufferHeight;const f=r.LineRenderer.FLOATS_PER_LOCATION,m=r.LineRenderer.FLOATS_PER_OFFSET,g=r.LineRenderer.FLOATS_PER_VERTEX*Float32Array.BYTES_PER_ELEMENT;b.useProgram(c.program);b.uniform4fv(c.colorHandle,h);b.uniformMatrix4fv(c.modelViewMatrixHandle,!1,e);b.uniformMatrix4fv(c.projectionMatrixHandle,!1,a);b.uniform2fv(c.resolutionHandle,d);e=l.length;for(h=0;h<e;h++)a=l[h],k.bindBuffer(a.vertices,
c.currentHandle,f,b.FLOAT,g,0),k.bindBuffer(a.vertices,c.otherHandle,f,b.FLOAT,g,f*Float32Array.BYTES_PER_ELEMENT),k.bindBuffer(a.vertices,c.normalDisplacementHandle,m,b.FLOAT,g,2*f*Float32Array.BYTES_PER_ELEMENT),k.bindBuffer(a.vertices,c.parallelDisplacementHandle,m,b.FLOAT,g,2*f*Float32Array.BYTES_PER_ELEMENT+m*Float32Array.BYTES_PER_ELEMENT),b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,a.indices),b.drawElements(b.TRIANGLES,a.nindices,b.UNSIGNED_SHORT,0)};const k=q,b=k.getGLContext(),c=this.createProgram()};
...
(function(r){r.SimpleVectorField=function(q,k){this.setLineWidth=function(g){l.setLineWidth(g);return this};this.getLineWidth=function(){l.getLineWidth()};this.setArrowHeadWidth=function(g){l.setArrowHeadWidth(g);return this};this.getArrowHeadWidth=function(){return l.getArrowHeadWidth()};this.setArrowHeadSize=function(g){l.setArrowHeadSize(g);return this};this.getArrowHeadSize=function(){return l.getArrowHeadSize()};this.setArrowSize=function(g){l.setArrowSize(g);return this};this.getArrowSize=function(){return l.getArrowSize()};
...
return this};this.getStartPoints=function(){return l.getStartPoints()};this.setupVectorField=function(){let g,t=[];g={};if("function"===typeof a.getStartPoints){var n=a.getStartPoints(0,2);"undefined"!==typeof n&&0<n.length&&l.addStartPoints(n)}n=l.generateField();g.vertices=h.createBuffer(n.getVertices());g.indices=h.createIndexBuffer(n.getIndices());g.nindices=n.getNindices();t[0]=g;return t};this.render=function(){c&&(a.isModified()&&(e=this.setupVectorField()),h.clear(),d.drawIndexedLines(m,f,
b,e),a.setModified(!1))};this.start=function(){c=!0;this.render()};let b=new Float32Array([.8,.3,.3,1]),c=!1;const a=k;let e;const h=q.getGlUtility(),l=new vizit.vectorfield.VectorFieldGenerator(a),d=new vizit.vectorfield.LineRenderer(h);h.clearColor(0,0,0,0);let f=q.getModelViewMatrix(),m=q.getProjectionMartix();q.registerRenderer(this)}})(window.vizit.vectorfield);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};(function(r){r.CountdownLatch=function(q,k){var b=q;this.countDown=function(){b--;0>=b&&k()}}})(window.vizit.utility);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
(function(r){r.ChargeGenerator=function(q){var k,b,c;this.setCharges=function(f){k=f;if(!b||a*k.getCharges().length>b.byteLength)b=new ArrayBuffer(a*k.getCharges().length)};this.getCharges=function(){return k};this.getChargesArray=function(){return b};this.getNcharges=function(){return c};this.generate=function(){var f=k.getCharges();c=f.length;var m=new Float32Array(b);var g=new Uint8Array(b);for(var t=0;t<c;t++){var n=f[t];var p=n.getPosition();var v=5*t;m[v++]=p[0];m[v++]=p[1];m[v++]=p[2];m[v++]=
e;v=16+20*t;n=0<n.getCharge()?l:0>n.getCharge()?h:d;g[v++]=n[0];g[v++]=n[1];g[v++]=n[2];g[v++]=n[3]}return b};var a=3*Float32Array.BYTES_PER_ELEMENT+Float32Array.BYTES_PER_ELEMENT+4*Uint8Array.BYTES_PER_ELEMENT;var e=16;var h=[204,13,13,255];var l=[13,13,204,255];var d=[13,13,13,51]}})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
(function(r){r.ChargeRenderer=function(q){this.createProgram=function(){const a=k.createProgram("precision highp float;attribute vec3  position;attribute vec4  color;attribute float size;uniform   mat4  modelViewMatrix;uniform   mat4  projectionMatrix;varying vec4 vColor;void main(){    gl_Position  = projectionMatrix * modelViewMatrix * vec4(position, 1);    gl_PointSize = size;    vColor       = color;}","precision mediump float;varying vec4 vColor;uniform   vec3 ambientLighting;uniform   vec3 directionalLighting; void main() {   vec2  position  = gl_PointCoord - vec2(0.5,0.5);   if ( length(position) > 0.5 )     discard;   float z         = sqrt(0.5*0.5 - position.x*position.x - position.y*position.y);   vec3  normal    = normalize(vec3(position, z));   float specular  = dot(normal, directionalLighting);   specular        = specular  <= 0.0 ? 0.0 : pow(specular , 15.0);   gl_FragColor    = vec4(vColor.rgb * ambientLighting + vColor.rgb*specular, vColor.a); }"),e=
k.getAttribLocation(a,"color"),h=k.getAttribLocation(a,"position"),l=k.getAttribLocation(a,"size"),d=k.getUniformLocation(a,"ambientLighting"),f=k.getUniformLocation(a,"directionalLighting"),m=k.getUniformLocation(a,"modelViewMatrix"),g=k.getUniformLocation(a,"projectionMatrix");return{program:a,colorHandle:e,positionHandle:h,sizeHandle:l,ambientLightingHandle:d,directionalLightingHandle:f,modelViewMatrixHandle:m,projectionMatrixHandle:g}};this.render=function(a,e,h,l){l=l.getNcharges();0<l&&(b.useProgram(c.program),
...
(function(r){r.FieldLine=function(q){function k(n,p,v,A,x,w,y){m[g++]=n;m[g++]=p;m[g++]=v;m[g++]=A;m[g++]=x;m[g++]=w;m[g++]=y}function b(n,p,v){h[e++]=n.x;h[e++]=n.y;h[e++]=n.z;h[e++]=p.x;h[e++]=p.y;h[e++]=p.z;h[e++]=v}let c,a,e,h,l,d,f,m,g,t;this.setMaxPoints=function(n){n!==l&&(l=n,m=new Float32Array(r.FieldLine.FLOATS_PER_SEGMENT*(l-1)),h=new Float32Array(l),c=new Uint16Array(l),this.reset());return this};this.getMaxPoints=function(){return l};this.pushPoint=function(n,p,v){0<f&&(k(t.x,t.y,t.z,
n,p,v,1),k(t.x,t.y,t.z,n,p,v,-1),k(n,p,v,t.x,t.y,t.z,-1),k(n,p,v,t.x,t.y,t.z,1));t={x:n,y:p,z:v};f++};this.getPoints=function(){return m};this.getNpoints=function(){return f};this.pushArrow=function(n,p){b(n,p,1);b(n,p,0);b(p,p,0);b(n,p,-1);n=d*r.FieldLine.VERTICES_PER_ARROW;c[a++]=n;c[a++]=n+1;c[a++]=n+2;c[a++]=n+2;c[a++]=n+1;c[a++]=n+3;d++};this.getArrows=function(){return{vertices:h.slice(0,vizit.electricfield.FieldLine.VERTICES_PER_ARROW*vizit.electricfield.FieldLine.FLOATS_PER_VERTEX*d),indices:c.slice(0,
vizit.electricfield.FieldLine.INDICES_PER_ARROW*d),narrows:d}};this.getNarrows=function(){return d};this.reset=function(){g=f=d=e=a=0};this.setMaxPoints(q)};r.FieldLine.FLOATS_PER_LOCATION=3;r.FieldLine.LOCATIONS_PER_VERTEX=2;r.FieldLine.FLOATS_PER_DIRECTION=1;r.FieldLine.FLOATS_PER_VERTEX=r.FieldLine.LOCATIONS_PER_VERTEX*r.FieldLine.FLOATS_PER_LOCATION+r.FieldLine.FLOATS_PER_DIRECTION;r.FieldLine.VERTICES_PER_SEGMENT=4;r.FieldLine.FLOATS_PER_SEGMENT=r.FieldLine.VERTICES_PER_SEGMENT*r.FieldLine.FLOATS_PER_VERTEX;
r.FieldLine.VERTICES_PER_ARROW=4;r.FieldLine.INDICES_PER_ARROW=6})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
(function(r){r.FieldLineGenerator=function(q,k){let b,c,a,e,h,l,d;this.setCharges=function(f){h=f;return this};this.getCharges=function(){return h};this.getArrows=function(){return arrows};this.setMaxPoints=function(f){f>maxpoints&&(l=new vizit.electricfield.FieldLine(d));d=f;return this};this.getMaxPoints=function(){return d};this.setArrowLength=function(f){b=f;return this};this.getArrowLength=function(){return b};this.setArrowWidth=function(f){c=f;return this};this.getArrowWidth=function(){return c};
this.setArrowSpacing=function(f){a=f;return this};this.getArrowSpacing=function(){return a};this.setDs=function(f){e=f;return this};this.getDs=function(){return e};this.drawArrow=function(f,m,g,t,n,p,v){v.pushArrow({x:f-p*t[0]/n,y:m-p*t[1]/n,z:g-p*t[2]/n},{x:f,y:m,z:g})};this.generate=function(f,m,g,t){var n=0;var p=!1;var v=g;l.reset();for(g=0;g<d&&!p;g++){l.pushPoint(f,m,v);var A=h.getField(f,m,v);p=Math.sqrt(A[0]*A[0]+A[1]*A[1]+A[2]*A[2]);if(0===p)break;f+=t*A[0]/p*e;m+=t*A[1]/p*e;v+=t*A[2]/p*
e;n+=e;n>a&&(n=0,this.drawArrow(f,m,v,A,p,b,l));p=h.shouldStop(t,f,m,v)}return l};b=r.FieldLineGenerator.DEFAULT_ARROW_LENGTH;a=r.FieldLineGenerator.DEFAULT_ARROW_SPACING;e=k;d=q;l=new vizit.electricfield.FieldLine(d)};r.FieldLineGenerator.DEFAULT_ARROW_LENGTH=4;r.FieldLineGenerator.DEFAULT_ARROW_SPACING=24})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
(function(r){r.FieldLineRenderer=function(q){let k=r.FieldLineRenderer.DEFAULT_LINE_WIDTH,b=r.FieldLineRenderer.DEFAULT_ARROW_WIDTH;this.setLineWidth=function(l){k=l;return this};this.getLineWidth=function(){return k};this.setArrowWidth=function(l){b=l;return this};this.getArrowWidth=function(){return b};this.createProgram=function(l){const d=l.createProgram("attribute vec3  current;attribute vec3  other;attribute float direction;uniform   float aspect;uniform   float halfWidth;uniform   mat4  modelViewMatrix;uniform   mat4  projectionMatrix;void main(){  mat4 projModelView    = projectionMatrix * modelViewMatrix;  vec4 currentProjected = projModelView * vec4(current, 1.0);  vec4 otherProjected   = projModelView * vec4(other, 1.0);  vec2 currentScreen    = currentProjected.xy / currentProjected.w;  currentScreen.x      *= aspect;  vec2 otherScreen      = otherProjected.xy / otherProjected.w;  otherScreen.x        *= aspect;  vec2 dir              = normalize(currentScreen - otherScreen);  vec2 normal           = vec2(-dir.y, dir.x);  normal               *= halfWidth;  normal.x             /= aspect;  vec4 offset = vec4(normal * direction, 0.0, 0.0);  gl_Position = currentProjected + offset;}","precision mediump float;void main(){  gl_FragColor = vec4(0.8,0.3,0.3,1.0);}"),
f=l.getAttribLocation(d,"current"),m=l.getAttribLocation(d,"direction"),g=l.getAttribLocation(d,"other"),t=l.getUniformLocation(d,"aspect"),n=l.getUniformLocation(d,"halfWidth"),p=l.getUniformLocation(d,"modelViewMatrix");l=l.getUniformLocation(d,"projectionMatrix");return{program:d,currentHandle:f,directionHandle:m,otherHandle:g,aspectHandle:t,halfWidthHandle:n,modelViewMatrixHandle:p,projectionMatrixHandle:l}};this.createArrowProgram=function(l){const d=l.createProgram("attribute vec3  current;attribute vec3  tip;attribute float direction;uniform   float aspect;uniform   float halfWidth;uniform   mat4  modelViewMatrix;uniform   mat4  projectionMatrix;void main(){  mat4 projModelView    = projectionMatrix * modelViewMatrix;  vec4 currentProjected = projModelView * vec4(current, 1.0);  vec4 tipProjected   =   projModelView * vec4(tip, 1.0);  vec2 currentScreen    = currentProjected.xy / currentProjected.w;  currentScreen.x      *= aspect;  vec2 tipScreen        = tipProjected.xy / tipProjected.w;  tipScreen.x          *= aspect;  vec2 dir              = currentScreen - tipScreen;  vec2 normal           = (dir == vec2(0.0, 0.0) ? vec2(0.0, 0.0) : normalize(vec2(-dir.y, dir.x)));  normal               *= halfWidth;  normal.x             /= aspect;  vec4 offset = (direction == 0.0 ?                             vec4(0.0, 0.0, 0.0, 0.0) :                              vec4((normal * direction / currentProjected.w) + dir/3.0, 0.0, 0.0));  gl_Position = currentProjected + offset;}",
"precision mediump float;void main(){  gl_FragColor = vec4(0.8,0.3,0.3,1.0);}"),f=l.getAttribLocation(d,"current"),m=l.getAttribLocation(d,"direction"),g=l.getAttribLocation(d,"tip"),t=l.getUniformLocation(d,"aspect"),n=l.getUniformLocation(d,"halfWidth"),p=l.getUniformLocation(d,"modelViewMatrix");l=l.getUniformLocation(d,"projectionMatrix");return{program:d,currentHandle:f,directionHandle:m,tipHandle:g,aspectHandle:t,halfWidthHandle:n,modelViewMatrixHandle:p,projectionMatrixHandle:l}};this.render=
function(l,d,f,m){const g=a.drawingBufferWidth/a.drawingBufferHeight,t=vizit.electricfield.FieldLine.FLOATS_PER_LOCATION,n=m.length,p=vizit.electricfield.FieldLine.FLOATS_PER_VERTEX*Float32Array.BYTES_PER_ELEMENT;if(0<n){a.useProgram(e.program);a.uniformMatrix4fv(e.modelViewMatrixHandle,!1,d);a.uniformMatrix4fv(e.projectionMatrixHandle,!1,l);a.uniform1f(e.aspectHandle,g);a.uniform1f(e.halfWidthHandle,k/a.drawingBufferHeight);for(var v=0;v<n;v++){f=m[v];if(!f.isEnabled())break;c.bindBuffer(f.fieldLineBufferHandle,
e.currentHandle,t,a.FLOAT,p,0);c.bindBuffer(f.fieldLineBufferHandle,e.otherHandle,t,a.FLOAT,p,t*Float32Array.BYTES_PER_ELEMENT);c.bindBuffer(f.fieldLineBufferHandle,e.directionHandle,1,a.FLOAT,p,2*t*Float32Array.BYTES_PER_ELEMENT);a.drawArrays(a.TRIANGLE_STRIP,0,4*(f.npoints-1))}a.useProgram(h.program);a.enableVertexAttribArray(h.tipHandle);a.enableVertexAttribArray(h.directionHandle);a.uniformMatrix4fv(h.modelViewMatrixHandle,!1,d);a.uniformMatrix4fv(h.projectionMatrixHandle,!1,l);a.uniform1f(h.aspectHandle,
g);a.uniform1f(h.halfWidthHandle,b/2/a.drawingBufferHeight);for(l=0;l<n;l++){f=m[l];if(!f.isEnabled())break;c.bindBuffer(f.fieldDirectionBufferHandle,h.currentHandle,t,a.FLOAT,p,0);c.bindBuffer(f.fieldDirectionBufferHandle,h.tipHandle,t,a.FLOAT,p,t*Float32Array.BYTES_PER_ELEMENT);c.bindBuffer(f.fieldDirectionBufferHandle,h.directionHandle,1,a.FLOAT,p,2*t*Float32Array.BYTES_PER_ELEMENT);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,f.fieldDirectionIndices);a.drawElements(a.TRIANGLES,6*f.narrows,a.UNSIGNED_SHORT,
0)}}};const c=q,a=c.getGLContext(),e=this.createProgram(c),h=this.createArrowProgram(c)};r.FieldLineRenderer.DEFAULT_LINE_WIDTH=3;r.FieldLineRenderer.DEFAULT_ARROW_WIDTH=5*r.FieldLineRenderer.DEFAULT_LINE_WIDTH})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.utility=window.vizit.utility||{};
(function(r){r.Cylinder=function(){var q;this.setColor=function(b){q=b};this.getColor=function(){return q};this.getCylinderModelView=function(b,c,a,e,h,l,d){var f=Math.sin(d);d=Math.cos(d);var m=Math.sin(l);l=Math.cos(l);var g=new Float32Array(16);g[0]=h*l*d;g[1]=h*d*m;g[2]=-h*f;g[3]=0;g[4]=-h*m;g[5]=h*l;g[6]=0;g[7]=0;g[8]=e*l*f;g[9]=e*m*f;g[10]=e*d;g[11]=0;g[12]=b;g[13]=c;g[14]=a;g[15]=1;return g};this.transformPoints=function(b,c,a,e){k[0]=b[0]*a;k[1]=b[1]*a;k[2]=b[2]*a;k[3]=b[3];k[4]=b[4]*a;k[5]=
...
this.getNindices())}};var h=new vizit.utility.Color(.5,.5,.5,.5);var l=!0;var d=a;var f=c;var m=q;var g=k;var t=b};r.GaussianSphere.prototype=new vizit.geometry.Sphere})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
(function(r){r.ChargedCylinder=function(q,k,b,c,a,e,h,l,d,f,m,g){var t,n,p,v,A,x;this.setHeight=function(C){t=C;w=!0};this.getHeight=function(){return t};this.setTx=function(C){v=C;w=!0;return this};this.getTx=function(){return v};this.setTy=function(C){A=C;w=!0;return this};this.getTy=function(){return A};this.setTz=function(C){x=C;w=!0;return this};this.getTz=function(){return x};this.setX0=function(C){K=C;w=!0;return this};this.getX0=function(){return K};this.setY0=function(C){M=C;w=!0;return this};
...
"undefined"===typeof h?0:h;this.setColor(this.computeColor(A));var x=!0;var w=f;var y="undefined"===typeof l?0:l;var J="undefined"===typeof d?0:d;var z=0;var G=3;var E=q;var F=k;var K=b;var M=c;var O=a;var S=e;this.translateBounds(this,E,F,K,M,O,S);this.zAxisRotation(this,E,F,M,O);this.yAxisRotation(this,E,F,K,M,O,S);this.scale(this,K,S);E=q;F=k;K=b;M=c;O=a;S=e;var W=this.getCylinderModelView(n,p,v,this.getBaseHeight(),this.getBaseRadius(),g,t);var X=M-E;var Y=O-F;var U=S-K;var T=Math.sqrt(X*X+Y*
...
!1,this.getModelView(O));this.drawFullSurface(z,G,M.vertices,M.normals,M.indices,n)}F.cullFace(F.BACK);for(E=p;E<=x;E++)O=E/K,this.drawFullSurface(z,G,M.vertices,M.normals,M.indices,n),F.uniformMatrix4fv(G.getModelViewMatrixHandle(),!1,this.getModelView(O))}};r.ChargedSphere.prototype=new vizit.geometry.Sphere})(window.vizit.electricfield);window.vizit=window.vizit||{};window.vizit.electricfield=window.vizit.electricfield||{};
(function(r){r.Charge=function(q,k,b,c,a,e,h){var l;this.setCharge=function(p){d=vizit.utility.ensureNumber(p);f=!0};this.getCharge=function(){return d};this.setX=function(p){g[0]=vizit.utility.ensureNumber(p);f=!0};this.getX=function(){return g[0]};this.setY=function(p){g[1]=vizit.utility.ensureNumber(p);f=!0};this.getY=function(){return g[1]};this.setZ=function(p){g[2]=vizit.utility.ensureNumber(p);f=!0};this.getZ=function(){return g[2]};this.setPosition=function(p){g=p;f=!0};this.getPosition=function(){return g};
...
this.getModelViewMatrix=function(){return g};this.setProjectionMatrix=function(w){t=w;return this};this.addStartPoint=function(w,y,J,z){d.push([w,y,J,z]);return this};this.addStartPoints=function(w){d=d.concat(w)};this.getStartPoints=function(){return d};this.render=function(){if(f){var w=m.getGLContext();b.chargesModified()?(this.setupCharges(),this.setupFieldLines()):b.distributionsModified()&&this.setupFieldLines();m.clear();A.render(t,g,k,b);v.render(t,g,c,a);w.enable(w.BLEND);w.enable(w.CULL_FACE);
w.blendFunc(w.SRC_ALPHA,w.ONE_MINUS_SRC_ALPHA);x.render(t,g,l,b.getDistributions());w.disable(w.DEPTH_TEST);x.render(t,g,l,e);w.enable(w.DEPTH_TEST);w.disable(w.BLEND);w.disable(w.CULL_FACE);b.setModified(!1)}};this.setupCharges=function(w){k||(w=m.getGLContext(),k=w.createBuffer());w=n.generate();m.loadData(k,w)};this.setupFieldLines=function(){var w;var y=[];y=y.concat(b.getStartPoints(0,5));y=y.concat(d);var J=y.length;var z=a.length;var G=Math.min(J,z);for(w=0;w<G;++w){var E=y[w];E=p.generate(E[0],
E[1],E[2],E[3]);a[w].reload(m,E)}for(;w<z;++w)a[w].disable();for(;w<J;++w)E=y[w],E=p.generate(E[0],E[1],E[2],E[3]),a.push(new vizit.electricfield.FieldLineVBO(m,E))};this.start=function(){f=!0;this.render()};var c=new Float32Array([.8,.3,.3,1]);var a=[];var e=[];var h=5;var l=new Float32Array([1,0,0,0,1,0,0,0,1]);var d=[];var f=!1;const m=q.getGlUtility();m.clearColor(0,0,0,0);let g=q.getModelViewMatrix(),t=q.getProjectionMartix();q.registerRenderer(this);const n=new vizit.electricfield.ChargeGenerator,
...
this.getArrowHeadSize=function(){return c};this.setArrowHeadWidth=function(g){b=g;return this};this.getArrowHeadWidth=function(){return b};this.setVectorSpacing=function(g){m=g;return this};this.getVectorSpacing=function(){return m};this.setDs=function(g){l=g;return this};this.getDs=function(){return l};this.pushVertex=function(g,t,n,p,v){g.push(t.x);g.push(t.y);g.push(t.z);g.push(n.x);g.push(n.y);g.push(n.z);g.push(p);g.push(v)};this.generateVector=function(g,t,n,p,v,A,x,w,y,J,z){v={};v.x=g;v.y=
t;v.z=n;const G={};G.x=g+p[0]*y;G.y=t+p[1]*y;G.z=n+p[2]*y;this.pushVertex(z,v,G,A,0);this.pushVertex(z,v,G,-A,0);this.pushVertex(z,G,v,-A,x);this.pushVertex(z,G,v,A,x);this.pushVertex(z,G,v,w,1.33*x);this.pushVertex(z,G,v,0,x);this.pushVertex(z,G,v,0,0);this.pushVertex(z,G,v,-w,1.33*x);g=8*J;z.pushIndex(g);z.pushIndex(g+1);z.pushIndex(g+2);z.pushIndex(g+2);z.pushIndex(g+1);z.pushIndex(g+3);z.pushIndex(g+4);z.pushIndex(g+5);z.pushIndex(g+6);z.pushIndex(g+6);z.pushIndex(g+5);z.pushIndex(g+7)};this.trace=
function(g,t,n,p,v,A,x,w,y){var J,z,G;var E=G=J=0;for(z=!1;E<A&&!z;){var F=g.getField(t,n,p);z=Math.sqrt(F[0]*F[0]+F[1]*F[1]+F[2]*F[2]);if(0===z)break;J>=G&&(this.generateVector(t,n,p,F,z,a,c,b,w,x+E,y),G=J+Math.max(z*m*w,1),E++);t+=v*F[0]/z*l;n+=v*F[1]/z*l;p+=v*F[2]/z*l;J+=l;z=g.shouldStop(v,t,n,p)}return E};this.generateField=function(){var g;var t=h.length;k=0;var n=new vizit.utility.IndexedVertices(vizit.vectorfield.LineRenderer.VERTICES_PER_ARROW*vizit.vectorfield.LineRenderer.FLOATS_PER_VERTEX*
f*t,12*f*t);for(g=0;g<t;g++){var p=h[g];p[4]=k;k+=this.trace(d,p[0],p[1],p[2],p[3],f,k,e,n)}return n};let b=r.VectorFieldGenerator.DEFAULT_ARROW_HEAD_WIDTH,c=r.VectorFieldGenerator.DEFAULT_ARROW_HEAD_SIZE,a=r.VectorFieldGenerator.DEFAULT_LINE_WIDTH,e=r.VectorFieldGenerator.DEFAULT_ARROW_SIZE,h=[],l=r.VectorFieldGenerator.DEFAULT_DS,d=q,f=r.VectorFieldGenerator.DEFAULT_MAX_VECTORS,m=r.VectorFieldGenerator.DEFAULT_VECTOR_SPACING};r.VectorFieldGenerator.DEFAULT_ARROW_HEAD_WIDTH=10;r.VectorFieldGenerator.DEFAULT_ARROW_HEAD_SIZE=
...
this.bind=function(q,k,b){if(k)if(Array.isArray(k)){var c=k.length;for(var a=0;a<c;++a)this.bindingBuilder(q,k[a],b)}else this.bindingBuilder(q,k,b)}};r.bindingBuilder=new r.BindingBuilder})(window.vizit.builder);window.vizit=window.vizit||{};window.vizit.builder=window.vizit.builder||{};
(function(r){r.CombinedVectorValuedFunctionBuilder=function(q){this.buildFunction=function(b){var c,a,e;for(e in b)"args"===e.toLowerCase()?c=b[e]:"body"===e.toLowerCase()?a=b[e]:"name"===e.toLowerCase()?name=b[e]:"properties"!==e.toLowerCase()&&"stop"!==e.toLowerCase()&&e.toLowerCase();return new vizit.vectorfield.VectorFunction(c,a)};this.build=function(b){var c,a;if(b){var e=new vizit.vectorfield.CombinedVectorFunctions;if(Array.isArray(b)){var h=b.length;for(var l=0;l<h;++l)if(c=this.buildFunction(b[l]))e.addFunction(c),
...
(function(r){r.SurfaceBuilder=function(){var q,k,b,c,a,e;this.getXMin=function(){return q};this.getXMax=function(){return k};this.getYMin=function(){return b};this.getYMax=function(){return c};this.getZMin=function(){return a};this.getZMax=function(){return e};this.gaussianCylinderBuilder=function(h){var l,d,f,m,g,t,n,p,v;var A=!0;for(m in h)"x"===m.toLowerCase()?n=h[m]:"y"===m.toLowerCase()?p=h[m]:"z"===m.toLowerCase()?v=h[m]:"h"===m.toLowerCase()?l=h[m]:"r"===m.toLowerCase()?g=h[m]:"phi"===m.toLowerCase()?
f=h[m]:"theta"===m.toLowerCase()?t=h[m]:"name"===m.toLowerCase()?d=h[m]:"enabled"===m.toLowerCase()&&(A=h[m]);q=Math.min(q,n-g,n+g);k=Math.max(k,n-g,n+g);b=Math.min(b,p-g,p-g);c=Math.max(c,p-g,p+g);a=Math.min(a,v-l,v+l);e=Math.max(e,v-l,v+l);h=new vizit.electricfield.GaussianCylinder(n,p,v,l,g,f,t,d);A||h.setEnabled(A);return h};this.gaussianSphereBuilder=function(h){var l,d,f,m,g,t;var n=!0;for(d in h)"x"===d.toLowerCase()?m=h[d]:"y"===d.toLowerCase()?g=h[d]:"z"===d.toLowerCase()?t=h[d]:"r"===d.toLowerCase()?
f=h[d]:"name"===d.toLowerCase()?l=h[d]:"enabled"===d.toLowerCase()&&(n=h[d]);q=Math.min(q,m-f,m+f);k=Math.max(k,m-f,m+f);b=Math.min(b,g-f,g-f);c=Math.max(c,g-f,g+f);a=Math.min(a,t-f,t+f);e=Math.max(e,t-f,t+f);h=new vizit.electricfield.GaussianSphere(m,g,t,f,l);n||h.setEnabled(n);return h};this.surfaceBuilder=function(h,l){var d,f,m,g;var t=/\s*gaussian\s*sphere\s*/i;for(f in h)"type"===f.toLowerCase()?g=h[f]:"bind"===f.toLowerCase()&&(d=h[f]);g.match(/\s*gaussian\s*cylinder\s*/i)?m=this.gaussianCylinderBuilder(h):
g.match(t)&&(m=this.gaussianSphereBuilder(h));"undefined"!==typeof d&&"undefined"!==m&&this.bind(m,d,l);return m};this.build=function(h,l,d){var f;if(h)if(Array.isArray(h)){var m=h.length;for(var g=0;g<m;++g)if(f=this.surfaceBuilder(h[g],d))l.addGaussianSurface(f),(name=f.getName())&&d.setElementName(f,name)}else if(f=this.surfaceBuilder(h,d))l.addGaussianSurface(f),(name=f.getName())&&d.setElementName(f,name);return l}};r.SurfaceBuilder.prototype=r.bindingBuilder})(window.vizit.builder);window.vizit=window.vizit||{};window.vizit.builder=window.vizit.builder||{};(function(r){r.VectorValuedFunctionBuilder=function(q){this.build=function(b,c){var a;if(b){var e=Array.isArray(b)?b[0]:b;"undefined"!==typeof e&&(a="function"===e.type.toLowerCase()?new vizit.builder.CombinedVectorValuedFunctionBuilder(k):new vizit.builder.ElectricFieldElementBuilder(k,c))}return a.build(b)};var k=q}})(window.vizit.builder);window.vizit=window.vizit||{};window.vizit.builder=window.vizit.builder||{};
(function(r){r.DistributionBuilder=function(){var q,k,b,c,a,e;this.getXMin=function(){return q};this.getXMax=function(){return k};this.getYMin=function(){return b};this.getYMax=function(){return c};this.getZMin=function(){return a};this.getZMax=function(){return e};this.chargedPlaneBuilder=function(d){var f,m,g,t,n,p,v,A,x,w,y,J,z,G,E,F,K;for(f in d)f.match(h)?m=d[f]:f.match(l)?g=d[f]:"nfieldLines"===f.toLowerCase()?n=d[f]:"x0"===f.toLowerCase()?p=d[f]:"y0"===f.toLowerCase()?v=d[f]:"z0"===f.toLowerCase()?
...
z,G,E,F,K,m,g,n,t)};this.chargedCylinderBuilder=function(d){var f,m,g,t,n,p,v,A,x,w,y,J,z;for(n in d)n.match(h)?f=d[n]:n.match(l)?m=d[n]:"nfieldLines"===n.toLowerCase()?t=d[n]:"x0"===n.toLowerCase()?p=d[n]:"y0"===n.toLowerCase()?v=d[n]:"z0"===n.toLowerCase()?A=d[n]:"x1"===n.toLowerCase()?x=d[n]:"y1"===n.toLowerCase()?w=d[n]:"z1"===n.toLowerCase()?y=d[n]:"r0"===n.toLowerCase()?J=d[n]:"r1"===n.toLowerCase()?z=d[n]:"name"===n.toLowerCase()&&(g=d[n]);q=Math.min(q,p,x);k=Math.max(k,p,x);b=Math.min(b,v,
w);c=Math.max(c,v,w);a=Math.min(a,A,y);e=Math.max(e,A,y);return new vizit.electricfield.ChargedCylinder(p,v,A,x,w,y,J,z,f,m,t,g)};this.chargedLineBuilder=function(d){var f,m,g,t,n,p,v,A,x,w,y;for(n in d)n.match(h)?f=d[n]:n.match(l)?m=d[n]:"nfieldLines"===n.toLowerCase()?t=d[n]:"x0"===n.toLowerCase()?p=d[n]:"y0"===n.toLowerCase()?v=d[n]:"z0"===n.toLowerCase()?A=d[n]:"x1"===n.toLowerCase()?x=d[n]:"y1"===n.toLowerCase()?w=d[n]:"z1"===n.toLowerCase()?y=d[n]:"name"===n.toLowerCase()&&(g=d[n]);q=Math.min(q,
p,x);k=Math.max(k,p,x);b=Math.min(b,v,w);c=Math.max(c,v,w);a=Math.min(a,A,y);e=Math.max(e,A,y);return new vizit.electricfield.ChargedLine(p,v,A,x,w,y,f,m,t,g)};this.chargedSphereBuilder=function(d){var f,m,g,t,n,p,v,A,x;for(let w in d)"charge"===w.toLowerCase()?f=d[w]:w.match(l)?m=d[w]:"nfieldLines"===w.toLowerCase()?t=d[w]:"x"===w.toLowerCase()?n=d[w]:"y"===w.toLowerCase()?p=d[w]:"z"===w.toLowerCase()?v=d[w]:"a"===w.toLowerCase()?A=d[w]:"b"===w.toLowerCase()?x=d[w]:"name"===w.toLowerCase()&&(g=d[w]);
q=Math.min(q,n-x);k=Math.max(k,n+x);b=Math.min(b,p-x);c=Math.max(c,p+x);a=Math.min(a,v-x);e=Math.max(e,v+x);return new vizit.electricfield.ChargedSphere(n,p,v,A,x,f,m,t,g)};this.chargeDistributionBuilder=function(d,f){var m,g,t,n;var p=/\s*charged\s*cylinder\s*/i;var v=/\s*charged\s*line\s*/i;var A=/\s*charged\s*sphere\s*/i;for(t in d)"type"===t.toLowerCase()?n=d[t]:"bind"===t.toLowerCase()&&(m=d[t]);n.match(/\s*charged\s*plane\s*/i)?g=this.chargedPlaneBuilder(d):n.match(p)?g=this.chargedCylinderBuilder(d):
n.match(v)?g=this.chargedLineBuilder(d):n.match(A)&&(g=this.chargedSphereBuilder(d));"undefined"!==typeof m&&"undefined"!==g&&this.bind(g,m,f);return g};this.build=function(d,f,m){var g,t;if(d)if(Array.isArray(d)){var n=d.length;for(var p=0;p<n;++p)if(g=this.chargeDistributionBuilder(d[p],m))f.addDistribution(g),(t=g.getName())&&m.setElementName(g,t)}else if(g=this.chargeDistributionBuilder(d,m))f.addDistribution(g),(t=g.getName())&&m.setElementName(g,t);return f};var h=/\s*charge\s*density\s*/i;
var l=/\s*field\s*line\s*density\s*/i};r.DistributionBuilder.prototype=r.bindingBuilder})(window.vizit.builder);window.vizit=window.vizit||{};window.vizit.builder=window.vizit.builder||{};
(function(r){r.ChargesBuilder=function(){this.getXMin=function(){return q};this.getXMax=function(){return k};this.getYMin=function(){return b};this.getYMax=function(){return c};this.getZMin=function(){return a};this.getZMax=function(){return e};this.chargeBuilder=function(h,l){var d,f,m,g,t,n,p,v,A;var x="";const w=/\s*field\s*line\s*density\s*/i;for(v in h)"charge"===v.toLowerCase()?A=h[v]:"x"===v.toLowerCase()?m=h[v]:"y"===v.toLowerCase()?g=h[v]:"z"===v.toLowerCase()?t=h[v]:v.match(w)?n=h[v]:"nfieldlines"===
...
q&&(q=m);m>k&&(k=m);g<b&&(b=g);g>c&&(c=g);t<a&&(a=t);t>e&&(e=t);var y=new vizit.electricfield.Charge(m,g,t,A,n,p,f);"undefined"!==typeof d&&this.bind(y,d,l)}return{charge:y,message:x}};this.build=function(h,l,d){if(h)if(Array.isArray(h)){var f=h.length;for(var m=0;m<f;++m){var g=this.chargeBuilder(h[m],d);const t=g.charge;g.message&&console.log(g.message);t&&(l.addCharge(t),(g=t.getName())&&d.setElementName(t,g))}}else g=this.chargeBuilder(h,d),h=g.charge,g.message&&console.log(g.message),h&&(l.addCharge(h),
(g=h.getName())&&d.setElementName(h,g));return l};var q=Number.POSITIVE_INFINITY;var k=Number.NEGATIVE_INFINITY;var b=Number.POSITIVE_INFINITY;var c=Number.NEGATIVE_INFINITY;var a=Number.POSITIVE_INFINITY;var e=Number.NEGATIVE_INFINITY};r.ChargesBuilder.prototype=r.bindingBuilder})(window.vizit.builder);window.vizit=window.vizit||{};window.vizit.builder=window.vizit.builder||{};
(function(r){r.ElectricFieldElementBuilder=function(q,k){this.buildELement=function(a,e){const h=/\s*charged\s*cylinder\s*/i,l=/\s*charged\s*line\s*/i,d=/\s*charged\s*plane\s*/i,f=/\s*charged\s*sphere\s*/i,m=/\s*gaussian\s*cylinder\s*/i,g=/\s*gaussian\s*sphere\s*/i;for(var t in a)if("type"===t.toLowerCase()){var n=a[t];break}if(n.match(/\s*charges?\s*$/i))n=new vizit.builder.ChargesBuilder,e=n.build(a,e,b);else if(n.match(h)||n.match(l)||n.match(d)||n.match(f))n=new vizit.builder.DistributionBuilder,
...
(function(r){r.ElectricFieldBuilder=function(q){this.build=function(b){var c,a,e,h,l,d,f,m;for(m in b)"arrowheadsize"===m.toLowerCase()?c=b[m]:"arrowwidth"===m.toLowerCase()?a=b[m]:"arrowspacing"===m.toLowerCase()?e=b[m]:"maxvectors"===m.toLowerCase()?f=b[m]:"linewidth"===m.toLowerCase()?d=b[m]:"elements"===m.toLowerCase()&&(l=b[m]);b=new vizit.electricfield.ElectricField(k);"undefined"!==typeof f&&b.setMaxVectors(f);"undefined"!==typeof c&&b.setArrowHeadSize(c);"undefined"!==typeof a&&b.setArrowWidth(a);
...
(function(r){r.SimpleVectorFieldBuilder=function(q){this.build=function(b){var c,a,e,h,l,d,f;for(f in b)"arrowheadsize"===f.toLowerCase()&&(c=b[f]),"arrowheadwidth"===f.toLowerCase()?a=b[f]:"arrowsize"===f.toLowerCase()?e=b[f]:"linewidth"===f.toLowerCase()?h=b[f]:"maxvectors"===f.toLowerCase()&&(l=b[f]),"f"===f.toLowerCase()&&(d=b[f]);if(d){b=new vizit.builder.VectorValuedFunctionBuilder(k);var m=b.build(d)}d=new vizit.vectorfield.SimpleVectorField(k,m);"undefined"!==typeof l&&d.setMaxVectors(l);
