...
g.length;for(var f=0;f<a;++f)this.bindingBuilder(g[f],h)}else this.bindingBuilder(g,h)}}})(window.vizit.builder);window.vizit=window.vizit||{};window.vizit.builder=window.vizit.builder||{};
